package com.riaancornelius.bot.pathfinding.example;
...
public class GameMap implements TileBasedMap {
	...
	public GameMap() {
		...
		fillArea(0,0,1,21,WATER);
		fillArea(0,0,21,1,WATER);
		fillArea(20,0,1,21,WATER);
		fillArea(0,20,21,1,WATER);

		for (int i = 0; i < 21; i+=2) {
			for (int j = 0; j < 21; j+=2) {
				if ( !(i==10 && j==10)) {
					fillArea(j,i,1,1,WATER);
				}
			}
		}

		fillArea(3,1,3,1,TREES);
		fillArea(5,1,1,3,TREES);

		// Center area
		fillArea(11,8,1,1,TREES);
		fillArea(9,8,1,1,TREES);
		fillArea(8,9,5,1,TREES);
		fillArea(8,11,5,1,TREES);
		fillArea(9,10,1,1,TREES);
		fillArea(11,10,1,1,TREES);
		fillArea(9,12,1,1,TREES);
		fillArea(11,12,1,1,TREES);
